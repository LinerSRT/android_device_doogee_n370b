...
LOCAL_PATH := device/doogee/n370b

$(call inherit-product-if-exists, vendor/doogee/n370b/n370b-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/doogee/n370b/overlay
PRODUCT_PACKAGE_OVERLAYS += device/doogee/n370b/overlay # enable this to be able overlay a default wallpaper
...
# Seccomp policy
PRODUCT_COPY_FILES += \
    device/doogee/n370b/seccomp/mediacodec.policy:system/vendor/etc/seccomp_policy/mediacodec.policy \
    device/doogee/n370b/seccomp/mediaextractor.policy:system/vendor/etc/seccomp_policy/mediaextractor.policy
    
# HIDL
PRODUCT_COPY_FILES += \
    device/doogee/n370b/hidl/manifest.xml:system/vendor/manifest.xml
